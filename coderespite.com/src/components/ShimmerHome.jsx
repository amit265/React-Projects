...
const ShimmerHome = (isLoading) => {
  return (
    <div
      className={`flex flex-wrap justify-center sm:overflow-x-auto sm:whitespace-nowrap py-4 transition-opacity duration-1000 ${
    ...
    >
      <div className="inline-flex flex-wrap justify-center items-center gap-4">
        ...
        {Array.from({ length: 4 }).map((_, index) => (
          <div
            key={index}
            className="w-80 h-96 bg-gray-200 rounded-lg shadow-md relative overflow-hidden"
          >
