...
export const projects = {
  react: [
    ...
    //   path: "calculator",
    //   description:
    //     "A simple React-based calculator app for basic arithmetic operations with a responsive design and intuitive interface.",
    // },
    // {
    //   id: "rt07",
    //   title: "Ecommerce App",
    //   path: "ecommerce-app",
    //   description:
    //     "A mock ecommerce application built with React, featuring product listings, a shopping cart, and checkout functionality.",
    // },
  ...
  javascript: [
    ...
    {
      id: "js13",
      title: "Quotes Infinite Scroll",
      path: "quotes-infinite-scroll",
      description:
