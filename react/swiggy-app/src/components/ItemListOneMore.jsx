...
const ItemListOneMore = ({ data }) => {
  ...
  {showMessage && (
      ...
      <div>
        ...
        <button className="p-2 bg-green-400 hover:bg-green-500 rounded-lg m-2" onClick={() => handleAddItem(data)}>Add</button>
      ...
      <div className="relative flex flex-col">
        <div className="w-32 h-32 p-2 relative">
          <img src={SWIGGY_CDN + imageId} alt="" className="object-cover w-full h-full" />
        </div>
        <button
